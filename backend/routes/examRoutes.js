...
import { 
  ...
  getStudentSolutions, getStudentSummary, getTeacherResults, getTeacherIntegrity,
  heartbeatExamSession, logExamActivity, startExamSession
...
router.get('/teacher/:examId/integrity', protect, requireTeacher, getTeacherIntegrity);
...
router.post('/student/:id/start', protect, requireStudent, startExamSession);
router.post('/student/:id/sessions/:sessionId/heartbeat', protect, requireStudent, heartbeatExamSession);
router.post('/student/:id/activity', protect, requireStudent, logExamActivity);
